...
//#define CP430_CORE_DEBUG			1	/* uncomment this line to direct debug messages to console */
...
#ifdef CP430_CORE_DEBUG
	#define PDEBUG(fmt, args...) printk("cp430_core: " fmt, ## args)
#else
