...
/* #define METEC_FLAT20_DEBUG		1 */	/* uncomment this line to direct debug messages to console */
...
#ifdef METEC_FLAT20_DEBUG
	#define PDEBUG(fmt, args...) printk("metec_flat20: " fmt, ## args)
#else
