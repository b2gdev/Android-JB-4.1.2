...
#define OMAP_TEMP_IRQ_BASE	(OMAP_GPMC_IRQ_END)
#define OMAP_TEMP_NR_IRQS	30
#define OMAP_TEMP_IRQ_END	(OMAP_TEMP_IRQ_BASE + OMAP_TEMP_NR_IRQS)

#define NR_IRQS			OMAP_TEMP_IRQ_END
