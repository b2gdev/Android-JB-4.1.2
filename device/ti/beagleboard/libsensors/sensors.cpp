...
static const struct sensor_t sSensorList[] = {
	...
	/*{ "Gyroscope sensor",
		...
		{"3 axis Compass",
		 ...
		 SENSORS_MAGNETIC_FIELD,RANGE_M,RESOLUTION_M,0.74f,16667, {}},
};
...
sensors_poll_context_t::sensors_poll_context_t()
{
	...
	mSensors[magnet] = new Compass();
	mPollFds[magnet].fd = mSensors[magnet]->getFd();
	mPollFds[magnet].events = POLLIN;
	mPollFds[magnet].revents = 0;
