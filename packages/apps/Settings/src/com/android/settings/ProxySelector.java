...
public class ProxySelector extends Fragment implements DialogCreatable {
    ...
    boolean saveToDb() {
        ...
        SystemProperties.set("net.http.proxy.host",hostname);
        SystemProperties.set("net.http.proxy.port",portStr);
        SystemProperties.set("net.http.proxy.excl.list",exclList);
