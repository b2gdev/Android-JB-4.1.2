...
/*
 * In x-loader, storing name and type of disk partition is not going to be useful.
 * Both these fields are initialized to null strings.
 */
#ifdef NOT_REQUIRED_IN_X_LOAD
